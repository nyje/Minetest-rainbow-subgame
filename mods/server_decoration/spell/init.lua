...
-- 	})
	...
	minetest.register_node(modname.."pmb", {
        description="Peppermint Butler by Rainbowdasy",
		tiles = { "peppermint_butler.png" },
		light_source = 14,
        inventory_image = "peppermint_butler.png",
		groups = {cracky=3, choppy=3},
		sounds = default.node_sound_glass_defaults(),
	})

    minetest.register_alias(modname.."nigel","air")
...
-- 	})
    ...
    minetest.register_alias(modname.."elektra","air")
