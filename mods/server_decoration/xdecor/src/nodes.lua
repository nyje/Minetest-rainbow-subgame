...
minetest.register_alias("xdecor:chair", "ts_furniture:rainbow_wood_brown_chair")
...
-- 		walkable = false,
-- 		tiles = {"plain_wool.png^[colorize:"..c..":170"},
-- 		inventory_image = "plain_wool.png^[colorize:"..c..
-- 			":170^xdecor_curtain_open_overlay.png^[makealpha:255,126,126",
-- 		wield_image = "plain_wool.png^[colorize:"..c..":170",
-- 		drawtype = "signlike",
-- 		paramtype2 = "wallmounted",
...
-- 	})
--
minetest.register_alias("xdecor:curtain_open_red","rainbow:curtain_open_red")
-- 	xdecor.register("curtain_open_"..c, {
-- 		tiles = {"plain_wool.png^[colorize:"..c..
-- 			 ":170^xdecor_curtain_open_overlay.png^[makealpha:255,126,126"},
-- 		drawtype = "signlike",
-- 		paramtype2 = "wallmounted",
-- 		walkable = false,
...
--
--     rainbow.add_node("xdecor:cushion", "Cushion", row, "", {
...
--     })
--
--     rainbow.add_node("xdecor:cushion_block", "Cushion Block",  row, "saw",{
--         tiles = {"xdecor_cushion.png"},
...
minetest.register_alias("xdecor:coalstone_tile", "rainbow:check_black")

--register_hard_node("desertstone_tile", "Desert Stone Tile")
minetest.register_alias("xdecor:desertstone_tile", "rainbow:stoneblock_darkred")
