...
minetest.register_alias("homedecor:cobweb_corner", "rainbow:cobweb_white")
...
minetest.register_alias("homedecor:cobweb_centered", "rainbow:cobweb_white")
...
minetest.register_alias("homedecor:cobweb_flat", "rainbow:cobweb_white")
...
minetest.register_alias("homedecor:cobweb_plantlike", "rainbow:cobweb_white")
