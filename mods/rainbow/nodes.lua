...
local box	= {-0.5,-0.5,-0.5,0.5,-0.45,0.5}
    ...
    add_node("lightframedcoolglass", "Light Cool Glass", row, "saw",{
    ...
    add_node("lightdirtycoolglass", "Light dirty Cool Glass", row, "saw",{
        tiles = {"plain_coolglass.png^(plain_stuff.png^[opacity:120)"},
        paramtype = "light",
        drawtype = "glasslike",
        light_source= default.LIGHT_MAX,
        sunlight_propagates = true,
